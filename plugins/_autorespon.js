...
handler.all = async function (m, { isBlocked }) {
    ...
    try {
        if (m.mentionedJid.includes(this.user.jid) && m.isGroup) {
            let image = ['', 'https://telegra.ph/file/a4032ee83c44bc712b085.png', 'https://telegra.ph/file/58e79875fa91a992726d7.png', 'https://telegra.ph/file/e808c24abb86c7500f4b1.png', 'https://telegra.ph/file/0f455c0cbbd6aeeff283f.png', 'https://telegra.ph/file/a595a3bedd97355650a8a.png', 'https://telegra.ph/file/4fd06cd5b884e3a80ba7b.png', 'https://telegra.ph/file/e16c377c3655d6fd79954.png', 'https://telegra.ph/file/70440fb145823d4aaa80d.png', 'https://telegra.ph/file/762e538b6a3a9345661d9.png']
...
Pembayaran bisa melalui: Gopay, Dana, Pulsa (Telkom)
`, m, { contextInfo: {
    externalAdReply: {
    ...
    if (setting.statusUpdate) {
        if (new Date() * 1 - setting.status > 1000) {
            ...
            await this.setStatus(`Aktif selama ${uptime} | Mode: ${settings.self ? 'Private' : settings.group ? 'Hanya Grup' : 'Publik'} | AuraBot by Muhammad Rifai`).catch(_ => _)
